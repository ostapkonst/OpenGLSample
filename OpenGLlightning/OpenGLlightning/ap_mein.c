...
GLuint vbo, vao, ind, uv, texture, norm;
...
void Display(void) {
	...
	glUniform3f(glGetUniformLocation(program, "LightPosition_worldspace"), 1, 1, 1);
	...
	glDrawElements(GL_TRIANGLES, ind_size * 3, GL_UNSIGNED_INT, 0);
...
int main(int argc, char * argv []) {
	...
	glGenBuffers(1, &norm);
	glBindBuffer(GL_ARRAY_BUFFER, norm);
	glBufferData(GL_ARRAY_BUFFER, mod_size * VERTEX_SIZE, normals, GL_STATIC_DRAW);
